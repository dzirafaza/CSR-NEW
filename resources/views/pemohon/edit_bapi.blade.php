...
<tr>
                    <td><label for="exampleInputName">YB) : Pemenerima Manfaat*</label></td>
</tr>    
                <tr>
                    <td>Nama</td>
                    <td>:</td>
...
<input type="text" class="form-control @error('nama') is-invalid @enderror" id="jabatan" placeholder="Nama Pemenerima Manfaat" name="nama" value="{{$rows->nama}}" required>
                ...
                <tr>
                    ...
                    <td>
               <div class="form-group">
<input type="text" class="form-control @error('jabatan') is-invalid @enderror" id="jabatan" placeholder="Jabatan Pemenerima Manfaat" name="jabatan" value="{{$rows->jabatan}}" required>
                ...
                <tr>
                    ...
                    <td>
               <div class="form-group">
<input type="text" class="form-control @error('alamat') is-invalid @enderror" id="alamat" placeholder="Alamat Pemenerima Manfaat" name="alamat" value="{{$rows->alamat}}" required>
...
<tr>
  ...
  <option value="barang">Barang</option>
    <option value="uang">Uang Cash</option>
...
<tr>
  <td><div><a onclick="goBack()" class="btn btn-danger ">Kembali</a></div></td>
  <td></td>
  <td></td>
<td>                      
            <div class="mb-3">
