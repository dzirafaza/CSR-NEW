    ...
    <div class="col-12">
        <div class="card ">
                                ...
                                <table>
                                    ...
                                    <tr>
                                        <td> <input
                                                ...
                                                id="exampleInputName" {{(old('check_judul') =='Ya' ) ? 'checked' : ''}}>
                                    ...
                                    <tr>
                                        <td>
                                            <input
                                                ...
                                                {{(old('check_data_diri.0') =='Ya' ) ? 'checked' : ''}}>
                                        ...
                                        <td><input class="form-check-input-sm" type="checkbox" value="Terlampir"
                                                aria-label="Checkbox for following text input" name="check_data_diri[]"
                                                {{(old('check_data_diri.1') =='Terlampir' ) ? 'checked' : ''}}>
                                            terlampir
                                            <input class="form-check-input-sm" type="checkbox" value="tidak terlampir"
                                                aria-label="Checkbox for following text input" name="check_data_diri[]"
                                                {{(old('check_data_diri.1') =='tidak terlampir' ) ? 'checked' : ''}}>
                                            tidak terlampir
                                        </td>
                                    </tr>
                                    <tr>
         ...
         padding: 8px 20px;">
                                        ...
                                        <td>Rp.{{ number_format($y->nominal, 0, ',', '.'); }},-</td>
                                        <td> {{$y->status}}</td>
                                    </tr>
                                    @endforeach
                                        ...
                                        <td>
                                            <div class="form-group">
                                                <input type="text"
                                                    ...
                                                    id="jabatan" placeholder="Nama Pemenerima Manfaat" name="nama"
                                        ...
                                        <td>
                                            <div class="form-group">
                                                <input type="text"
                                                    ...
                                                    id="jabatan" placeholder="Jabatan Pemenerima Manfaat" name="jabatan"
                                        ...
                                        <td>
                                            <div class="form-group">
                                                <input type="text"
                                                    ...
                                                    id="alamat" placeholder="Alamat Pemenerima Manfaat" name="alamat"
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <select class="form-control @error('jenis_bantuan') is-invalid @enderror"
                                                ...
                                                <option value="uang" @if (old("jenis_bantuan")=="uang" ) selected
                                                    @endif>
                                                    Uang
                                                </option>
