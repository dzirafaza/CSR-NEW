                                        ...
                                        <form method="POST"
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <div class="form-group">
                                                    <p style="text-align: left;"><b>File Evaluasi.pdf*</b></p>
                                                    <input type="file" class="form-control-file"
                                                        id="exampleFormControlFile1" name="file_val" required>
                                                </div>
                                                <div class="form-group">
                                                    <p style="text-align: left;"><b>File BA & PI.pdf*</b></p>
                                                    <input type="file" class="form-control-file"
                                                        id="exampleFormControlFile1" name="file_bapi" required>
                                                </div>
                                                <div class="form-group">
                                                    <p style="text-align: left;"><b>Surat Keputusan.pdf*</b></p>
                                                    <input type="file" class="form-control-file"
                                                        id="exampleFormControlFile1" name="file_sk" required>
                                                </div>
