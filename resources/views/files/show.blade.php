    ...
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                ...
                <button type="button" class="btn btn-warning btn-lg btn-block mt-3" data-toggle="modal"
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <table class="table table-borderless">
                                    <tr>
                                        <td>
                                            <h5 style="text-align: left;">File Evaluasi</h5>
                                        </td>
                                        <td>:</td>
                                        <td><a class="btn btn-success btn-sm btn-block"
                                                href="{{ route('files.download_evaluasi', $all->id_master) }}">Download</a>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                        ...
                                        <td>:</td>
                                        <td><a class="btn btn-success btn-sm btn-block"
                                                href="{{ route('files.download_bapi', $all->id_master) }}">Download</a>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                        ...
                                        <td>:</td>
                                        <td><a class="btn btn-success btn-sm btn-block"
                                                href="{{ route('files.download_sk', $all->id_master) }}">Download</a>
                                        </td>
                                    </tr>
                                </table>
